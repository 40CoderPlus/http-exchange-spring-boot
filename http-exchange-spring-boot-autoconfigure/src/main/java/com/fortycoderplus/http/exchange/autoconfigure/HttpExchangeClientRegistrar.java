...
public class HttpExchangeClientRegistrar
    ...
    private Set<String> getBasePackages(AnnotationMetadata importingClassMetadata) {
        Map<String, Object> attributes =
                importingClassMetadata.getAnnotationAttributes(EnableHttpInterfaces.class.getCanonicalName());
    ...
    private void registerHttpInterfaceClients(BeanDefinitionRegistry registry, AnnotationMetadata annotationMetadata) {
        try {
            ...
            BeanDefinitionBuilder bdb = BeanDefinitionBuilder.genericBeanDefinition(HttpExchangeClientFactory.class);
            bdb.addPropertyValue("type", target);
            Objects.requireNonNull(annotationMetadata.getAnnotationAttributes(HttpInterface.class.getName()))
